            ...
            courses.map((course, index) => {
              ...
              return (
                <Grid item xs={12} sm={6} key={index}>
                  ...
                  >
                    <CardContent>
                      <Typography variant="h5" sx={{ textAlign: "left", color: "#34405E" }}>
                      ...
                      <Typography variant="body1">
                        <strong>Seats Available:</strong> {course.seatsAvailable} / {course.classSize}
                      </Typography>
                      <Button variant="contained" color={isCourseAdded ? "secondary" : "primary"} onClick={() => handleAddCourse(course)} sx={{ mt: 2 }} disabled={isCourseAdded}>
